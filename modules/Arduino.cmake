...
# C only fine tunning
set(TUNING_FLAGS "-Wl,-u,vfprintf -Wl,--gc-sections -ffunction-sections -fdata-sections -fno-tree-scev-cprop -flto -fno-fat-lto-objects")
...
set(CMAKE_EXE_LINKER_FLAGS  "${CMAKE_EXE_LINKER_FLAGS} -lprintf_flt -lm" )
